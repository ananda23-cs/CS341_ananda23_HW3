 ...
 * --Local database used for this file
 */
 ...
 var host = "localhost";    //from local instance
 var database = "cheesecake";  //database name
 var user = "root";         //username (change to match your db)
 var password = "UPColl3g32023!";  //password (change to match your db, yes this is very poor practice)
